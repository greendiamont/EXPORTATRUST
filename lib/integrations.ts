...
export async function getIntegrationStatuses(): Promise<IntegrationStatus[]> {
  ...
  const gmail = has(env, "GOOGLE_CLIENT_ID", "GOOGLE_CLIENT_SECRET", "GOOGLE_REDIRECT_URI", "GOOGLE_TOKEN_ENCRYPTION_KEY");
  ...
  return [
    ...
    { id: "gmail", name: "Gmail operacional", category: "agents", state: gmail ? "operational" : "credential_required", label: gmail ? "OAUTH · PRONTO" : "AGUARDANDO AMBIENTE", detail: gmail ? "OAuth instalado para leitura, anexos, rascunhos e envio sujeito à aprovação humana." : "Configure as credenciais Google e a chave de criptografia no ambiente de execução.", provider: "Google Workspace", live: gmail },
